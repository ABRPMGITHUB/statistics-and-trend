...
# set labels 
df_matrix2 = df_drop[['Agricultural machinery, tractors per 100 sq. km of arable land', 'Rural land area (sq. km)', 'Land area (sq. km)', 'Average precipitation in depth (mm per year)', 'Forest area (% of land area)', 'Forest area (sq. km)', 'Rural land area where elevation is below 5 meters (sq. km)', 'Permanent cropland (% of land area)', 'Land under cereal production (hectares)', 'Arable land (% of land area)', 'Agricultural land (% of land area)', 'Agricultural land (sq. km)', 'Fertilizer consumption (kilograms per hectare of arable land)']]  


# In[19]:


df_corr2=df_matrix2.corr() #correlation
df_corr2.head() # showing correlation 
...
fig, Axis = mat_plot.subplots(figsize=(20,12)) 
im = Axis.imshow(df_corr2,cmap="cool_r")
...
Axis.set_title("Chile") 
mat_plot.show() 


# #Plotting figure for Italy

# In[21]:


data_cty4=function('Italy') # fatch country name 
data_cty4.to_csv('data_Italy.csv') # create new data set file 
data_cty5=pd.read_csv('/content/data_Italy.csv') 
data_cty6=data_cty5.drop(['Unnamed: 0'],axis=1) 
df_drop = data_cty6.fillna(0)


# In[22]:


df_matrix3 = df_drop[['Agricultural machinery, tractors per 100 sq. km of arable land', 'Rural land area (sq. km)', 'Land area (sq. km)', 'Average precipitation in depth (mm per year)', 'Forest area (% of land area)', 'Forest area (sq. km)', 'Rural land area where elevation is below 5 meters (sq. km)', 'Permanent cropland (% of land area)', 'Land under cereal production (hectares)', 'Arable land (% of land area)', 'Agricultural land (% of land area)','Agricultural land (sq. km)', 'Fertilizer consumption (kilograms per hectare of arable land)']]  


# In[23]:


df_corr3=df_matrix3.corr() 
df_corr3.head()
...
arr=df_corr3.to_numpy()
labs=df_matrix3.columns
fig, Axis = mat_plot.subplots(figsize=(20,12)) 
im = Axis.imshow(df_corr3,cmap="Purples_r")
